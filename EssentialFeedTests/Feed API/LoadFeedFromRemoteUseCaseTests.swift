...
final class LoadFeedFromRemoteUseCaseTests: XCTestCase {
    ...
    func test_load_deliversErrorOnNon200HTTPResponse() {
        ...
        samples.enumerated().forEach { index, code in
            expect(sut, toCompleteWith: .failure(FeedItemsMapper.Error.invalidData), when: {
    ...
    private func expect(_ sut: RemoteFeedLoader, toCompleteWith expectedResult: FeedLoader.Result, when action: () -> Void, file: StaticString = #file, line: UInt = #line) {
